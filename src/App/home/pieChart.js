export default function makePieOption(data){
...
let payment = []
for(var i = 0; i< 4; i++){
   payment.push({name: data[i].name, value:(data[i].amount)*1})
}
// 0: {name: '应收款', amount: 107800}
// 1: {name: '已收款', amount: '98977.25'}
// 2: {name: '未收款', amount: 8822.75}
// 3: {name: '应付款', amount: 107800}
// 4: {name: '已付款', amount: '58902.43'}
// 5: {name: '未付款', amount: 48897.57}
// var payment = [{
//     name: '已收款',
//     value: 20
// },{
